...
<div class="tour_wrap">
	<div class="tour_wrap_pic">
		<div class="img">
			<img src="${cpath }/resources/img/경기1.jpg" style="width:100%">
		</div>
	...
	<div class="tour_wrap_in">
		<div style="height: 100px; border-bottom: 1px solid black;">
			<div class="quick-link">
				<ul class="link-list">
					...
					<c:forEach var="package_middle" begin="15" end="15" items="${pmdto }">
							${package_middle.name }
					</c:forEach></a> * </li>
					<li class="link-list-item"><a href="#">
					<c:forEach var="package_middle" begin="16" end="16" items="${pmdto }">
							${package_middle.name }
					</c:forEach></a> * </li>
					<li class="link-list-item"><a href="#">
					<c:forEach var="package_middle" begin="17" end="17" items="${pmdto }">
							${package_middle.name }
					</c:forEach></a> * </li>
					<li class="link-list-item"><a href="#">
					<c:forEach var="package_middle" begin="18" end="18" items="${pmdto }">
							${package_middle.name }
					</c:forEach></a> * </li>
					<li class="link-list-item"><a href="#">
					<c:forEach var="package_middle" begin="19" end="19" items="${pmdto }">
							${package_middle.name }
					</c:forEach></a></li>
				</ul>
			</div>
		...
		<div style="width: 300px; height: 1100px;">
			...
			<hr>
			<div style="width:300px; height: 800px;" id="tour_gyeonggi_filter" >
				...
				<hr>	
				<div style="width: 250px; margin-left: 20px;">
					<h3><a href="#" id="tour_gyeonggi_filter_1">
						<c:forEach var="package_middle" begin="15" end="15" items="${pmdto }">
							${package_middle.name }
						</c:forEach>
					</a></h3>
					<div style="width: 250px; height: 330px; background-color: #F2F2F2; display: none;"
						...
						<c:forEach var="package_detail" begin="78" end="87" items="${pddto }">
				...
				<hr>
				<div style="width: 250px; margin-left: 20px">
					<h3><a href="#" id="tour_gyeonggi_filter_2" >
						<c:forEach var="package_middle" begin="16" end="16" items="${pmdto }">
							${package_middle.name }
						</c:forEach>
					</a></h3>
					<div style="width: 250px; height: 210px; background-color: #F2F2F2; display: none;"
						...
						<c:forEach var="package_detail" begin="88" end="93" items="${pddto }">
							${package_detail.name }<hr>
						</c:forEach>
					</div>
				</div>
				<hr>				
				<div style="width: 250px; margin-left: 20px">
					<h3><a href="#" id="tour_gyeonggi_filter_3" >
						<c:forEach var="package_middle" begin="17" end="17" items="${pmdto }">
							${package_middle.name }
						</c:forEach>
					</a></h3>
					<div style="width: 250px; height: 30px; background-color: #F2F2F2; display: none;"
						...
						<c:forEach var="package_detail" begin="94" end="94" items="${pddto }">
							${package_detail.name }<hr>
						</c:forEach>
					</div>
				</div>
				<hr>
				<div style="width: 250px; margin-left: 20px">
					<h3><a href="#" id="tour_gyeonggi_filter_4" >
						<c:forEach var="package_middle" begin="18" end="18" items="${pmdto }">
							${package_middle.name }
						</c:forEach>
					</a></h3>
					<div style="width: 250px; height: 30px; background-color: #F2F2F2; display: none;"
						...
						<c:forEach var="package_detail" begin="95" end="95" items="${pddto }">
							${package_detail.name }<hr>
						</c:forEach>
					</div>
				</div>
				<hr>
				<div style="width: 250px; margin-left: 20px">
					<h3><a href="#" id="tour_gyeonggi_filter_5" >
						<c:forEach var="package_middle" begin="19" end="19" items="${pmdto }">
							${package_middle.name }
						</c:forEach>
					</a></h3>
					<div style="width: 250px; height: 30px; background-color: #F2F2F2; display: none;"
						...
						<c:forEach var="package_detail" begin="96" end="96" items="${pddto }">
							${package_detail.name }<hr>
						</c:forEach>
					</div>
				</div>
			...
			<div style="width: 900px; height: 2000px; background-color: #eaeaea; overflow-y: scroll;">
				...
				<div class="hbox paging">
					<c:if test="${map.paging.prev }">
						<a href="${cpath }/tour/tour_gyeonggi/${map.paging.begin - 1}?type=${param.type}&word=${param.word}">◀</a>
					</c:if>
				</div>
				<c:forEach begin="${map.paging.begin }" end="${map.paging.end }" var="i">
					<a href="${cpath }/tour/tour_gyeonggi/${i}?type=${param.type}&word=${param.word}">
				...
				<c:if test="${map.paging.next }">
					<a href="${cpath }/tour/tour_gyeonggi/${map.paging.end + 1}?type=${param.type}&word=${param.word}">▶</a>
				</c:if>
				<c:choose>
...
<script>
	/* 필터 보이기 */
	$("#tour_gyeonggi_filter > div").click(function(){
		event.preventDefault();
		const idx = (event.target.id).split('_').reverse()[0];
		resultDiv = document.getElementById('tour_gyeonggi_filter_' + idx + '_in');
