...
<div class="tour_wrap">
	<div class="tour_wrap_pic">
		<div class="img">
			<img src="${cpath }/resources/img/전라1.jpg" style="width:100%">
		</div>
		...
		<div style="height: 100px; border-bottom: 1px solid black;">
			<div class="quick-link">
				<ul class="link-list">
					...
					<c:forEach var="package_middle" begin="20" end="20" items="${pmdto }">
							${package_middle.name }
					</c:forEach></a> * </li>
					<li class="link-list-item"><a href="#">
					<c:forEach var="package_middle" begin="21" end="21" items="${pmdto }">
							${package_middle.name }
					</c:forEach></a> * </li>
					<li class="link-list-item"><a href="#">
					<c:forEach var="package_middle" begin="22" end="22" items="${pmdto }">
							${package_middle.name }
					</c:forEach></a> * </li>
					<li class="link-list-item"><a href="#">
					<c:forEach var="package_middle" begin="23" end="23" items="${pmdto }">
							${package_middle.name }
					</c:forEach></a> * </li>
					<li class="link-list-item"><a href="#">
					<c:forEach var="package_middle" begin="24" end="24" items="${pmdto }">
							${package_middle.name }
					</c:forEach></a></li>
				</ul>
			</div>
	...
	<div style="height: 1200px; display: flex;">
		<div style="width: 300px; height: 1100px;">
			...
			<hr>
			<div style="width:300px; height: 800px;" id="tour_jeolla_filter" >
				...
				<hr>			
				<div style="width: 250px; margin-left: 20px;">
					<h3><a href="#" id="tour_jeolla_filter_1">
						<c:forEach var="package_middle" begin="20" end="20" items="${pmdto }">
							${package_middle.name }
						</c:forEach>
					</a></h3>
					<div style="width: 250px; height: 330px; background-color: #F2F2F2; display: none;"
							id="tour_jeolla_filter_1_in">
						<c:forEach var="package_detail" begin="97" end="106" items="${pddto }">
				...
				<hr>
				<div style="width: 250px; margin-left: 20px">
					<h3><a href="#" id="tour_jeolla_filter_2" >
						<c:forEach var="package_middle" begin="21" end="21" items="${pmdto }">
							${package_middle.name }
						</c:forEach>
					</a></h3>
					<div style="width: 250px; height: 210px; background-color: #F2F2F2; display: none;"
							id="tour_jeolla_filter_2_in">
						<c:forEach var="package_detail" begin="107" end="112" items="${pddto }">
							${package_detail.name }<hr>
						</c:forEach>
					</div>
				</div>
				<hr>
				<div style="width: 250px; margin-left: 20px">
					<h3><a href="#" id="tour_jeolla_filter_3" >
						<c:forEach var="package_middle" begin="22" end="22" items="${pmdto }">
							${package_middle.name }
						</c:forEach>
					</a></h3>
					<div style="width: 250px; height: 30px; background-color: #F2F2F2; display: none;"
							id="tour_jeolla_filter_3_in">
						<c:forEach var="package_detail" begin="113" end="113" items="${pddto }">
							${package_detail.name }<hr>
						</c:forEach>
					</div>
				</div>
				<hr>
				<div style="width: 250px; margin-left: 20px">
					<h3><a href="#" id="tour_jeolla_filter_4" >
						<c:forEach var="package_middle" begin="23" end="23" items="${pmdto }">
							${package_middle.name }
						</c:forEach>
					</a></h3>
					<div style="width: 250px; height: 60px; background-color: #F2F2F2; display: none;"
							id="tour_jeolla_filter_4_in">
						<c:forEach var="package_detail" begin="114" end="115" items="${pddto }">
							${package_detail.name }<hr>
						</c:forEach>
					</div>
				</div>
				<hr>
				<div style="width: 250px; margin-left: 20px">
					<h3><a href="#" id="tour_jeolla_filter_5" >
						<c:forEach var="package_middle" begin="24" end="24" items="${pmdto }">
							${package_middle.name }
						</c:forEach>
					</a></h3>
					<div style="width: 250px; height: 30px; background-color: #F2F2F2; display: none;"
							id="tour_jeolla_filter_5_in">
						<c:forEach var="package_detail" begin="116" end="116" items="${pddto }">
							${package_detail.name }<hr>
						</c:forEach>
					</div>
				</div>
		...
		<div style="width: 900px; height: 2000px; background-color: #eaeaea; overflow-y: scroll;">
				...
				<div class="hbox paging">
					<c:if test="${map.paging.prev }">
						<a href="${cpath }/tour/tour_jeolla/${map.paging.begin - 1}?type=${param.type}&word=${param.word}">◀</a>
					</c:if>
				</div>
				<c:forEach begin="${map.paging.begin }" end="${map.paging.end }" var="i">
					<a href="${cpath }/tour/tour_jeolla/${i}?type=${param.type}&word=${param.word}">
				...
				<c:if test="${map.paging.next }">
					<a href="${cpath }/tour/tour_jeolla/${map.paging.end + 1}?type=${param.type}&word=${param.word}">▶</a>
				</c:if>
				<c:choose>
...
<script>
	/* 필터 보이기 */
	$("#tour_jeolla_filter > div").click(function(){
		event.preventDefault();
		const idx = (event.target.id).split('_').reverse()[0];
		resultDiv = document.getElementById('tour_jeolla_filter_' + idx + '_in');
